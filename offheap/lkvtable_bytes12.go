...
type LKVTableListObjectWithBytes12 func(obj LKVTableObjectUPtrWithBytes12) bool
...
func (p *LKVTableWithBytes12) ListObject(listObject LKVTableListObjectWithBytes12) {
	var (
